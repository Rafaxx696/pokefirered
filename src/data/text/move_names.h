const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_POISON_STING]  = _("Picotazo V."),
    ...
    [MOVE_THUNDERBOLT]   = _("Trueno"),
    [MOVE_THUNDER_WAVE]  = _("Onda Trueno"),
    [MOVE_THUNDER]       = _("Rayo"),
    [MOVE_ROCK_THROW]    = _("Lanz. Roca"),
    ...
    [MOVE_HI_JUMP_KICK]  = _("P.Salto Alt."),
    ...
    [MOVE_DESTINY_BOND]  = _("Mismo Dest."),
