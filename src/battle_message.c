...
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} subio al \nNv.{B_BUFF2}!{WAIT_SE}\p");
...
static const u8 sText_GetOutGetOut[] = _("Fantasma: Fueeraaa…… Fueaaaraaaa……");
...
const u8 gText_BattleMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}Luchar{CLEAR_TO 56}Mochila\nPokémon{CLEAR_TO 56}Huir");
...
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}Si\nNo");
...
static const u8 sText_MaxHP[] = _("{FONT_SMALL}Max{FONT_NORMAL} PS");
