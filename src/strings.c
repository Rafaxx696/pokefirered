...
ALIGNED(4) const u8 gText_ABUTTONNext[] = _("{A_BUTTON}Siguiente");
ALIGNED(4) const u8 gText_ABUTTONNext_BBUTTONBack[] = _("{A_BUTTON}NEXT {B_BUTTON}BACK");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONNext_BBUTTONBack[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}NEXT {B_BUTTON}Salir");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONBBUTTONCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}{B_BUTTON}Salir");
...
const u8 gText_PickOKExit[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}OK {B_BUTTON}Salir");
const u8 gText_5Dashes[] = _("-----");
const u8 gText_PickFlipPageCheckCancel[] = _("{DPAD_LEFTRIGHT}PICK{PLUS}FLIP PAGE {A_BUTTON}CHECK {B_BUTTON}Salir");
...
const u8 gText_Lbs[] = _("kgs.");
const u8 gTextJP_PokemonData[] = _("ポケモンデ-タ");
const u8 gText_Cry[] = _("{START_BUTTON}Grito");
const u8 gText_NextDataCancel[] = _("{A_BUTTON}NEXT DATA {B_BUTTON}Salir");
const u8 gText_Next[] = _("{A_BUTTON}Sig.");
const u8 gText_CancelPreviousData[] = _("{A_BUTTON}Salir {B_BUTTON}PREVIOUS DATA");
const u8 gText_Area[] = _("Zona");
const u8 gText_Size[] = _("Tamaño");
const u8 gText_AreaUnknown[] = _("AREA UNKNOWN");
const u8 gText_PokedexNo[] = _("Nº ");
const u8 gText_Page[] = _("Pagina");
...
ALIGNED(4) const u8 gText_IDNumber[] = _("NoId.");
...
const u8 gText_CloseBag[] = _("Cerrar");
...
const u8 gText_TMCase[] = _("Bolsa MT");
...
const u8 gText_ShopQuit[] = _("Nos Vemos!");
...
const u8 gText_WontHaveEffect[] = _("No tiene ningun efecto.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} subio a\nNv.{STR_VAR_2}.");
...
const u8 gText_ChoosePokemon[] = _("Elige Pokémon o Salir.");
...
const u8 gText_CantSurfHere[] = _("No puedes Surfear aqui!");
...
const u8 gText_HelixFossil[] = _("Fosil Helix");
const u8 gText_DomeFossil[] = _("Fosil Domo");
const u8 gText_OldAmber[] = _("Ambar Viejo");
...
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("Hab. Pokémon");
...
const u8 gText_PokeSum_NextLv[] = _("Siguiente Nvl.");
const u8 gText_PokeSum_Controls_PageCancel[] = _("{DPAD_RIGHT}PAGE {A_BUTTON}Salir");
...
const u8 gText_TrainerCardIDNo[] = _("NoId.");
...
const u8 gText_Option[] = _("Opcciones");
...
const u8 gText_TextSpeedFast[] = _("Rapido");
...
const u8 gText_PickSwitchCancel[] = _("{DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}{B_BUTTON}Salir");
...
const u8 gText_LevelUp_MaxHP[] = _("{FONT_NORMAL}PS{FONT_SMALL} Max.");
...
const u8 gText_HelpSystemControls_AorBtoCancel[] = _("{A_BUTTON}{B_BUTTON}Salir");
const u8 gText_HelpSystemControls_PickOkCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}OK {B_BUTTON}Salir");
...
const u8 gTradeText_Summary[] = _("Datos");
...
const u8 gText_TradeAction_Summary[] = _("Datos");
...
const u8 gText_BButtonCancel[] = _("{B_BUTTON}Salir");
...
const u8 gFameCheckerText_PickScreenUI[] = _("{START_BUTTON}PICK {DPAD_UPDOWN}SELECT {B_BUTTON}Salir");
const u8 gFameCheckerText_FlavorTextUI[] = _("{DPAD_ANY}PICK {A_BUTTON}READ {B_BUTTON}Salir");
...
const u8 gText_DelAllCancelOk[] = _("DEL. ALL{CLEAR_TO 0x57}Salir{CLEAR_TO 0xA4}OK");
